...
COMANDO     : E ';'
            ...
            | BEGIN_FOR IDENTIFICADOR_FOR '=' E ':' E BLOCO CLOSE_FOR {
                    ...
                    $$.traducao += "\t" + nome_variavel + "->tipo" + " = 1;\n";
                    $$.traducao += "\t" + nome_variavel + "->i" + " = " + $4.label + ";\n";
                    ...
                    $$.traducao += "\t" + condicao + " = " + nome_variavel + "->i" + " > " + pre_condicao + ";\n"; 
                    $$.traducao += "\tif (" + condicao + ") goto " + label_fim + ";\n";

                    $$.traducao += $7.traducao;  

                    $$.traducao += label_incremento + ":\n";
                    $$.traducao += "\t" + nome_variavel + "->i" + " = " + nome_variavel + "->i" + " + 1;\n";
...
E           : E '+' E
            ...
            if(tipo == "char") {
                ...
                if($1.tipo == "Var" || $3.tipo == "Var") {
                    ...
                    $$.traducao = gerar_traducao_soma_var($1.label, $1.tipo, $1.traducao, $3.label, $3.tipo, $3.traducao, "esquerda");
                    $$.label = $1.label;
                    $$.tipo = "Var";
               ...
               if($3.tipo == "Var" && $1.tipo != "Var") {
                    ...
                    $$.traducao = gerar_traducao_soma_var($1.label, $1.tipo, $1.traducao, $3.label, $3.tipo, $3.traducao, "direita");
                    $$.label = $3.label;
                    $$.tipo = "Var";
                    ...
                    $$.traducao = gerar_traducao_soma_var($1.label, $1.tipo, $1.traducao, $3.label, $3.tipo, $3.traducao, "ambos");
                    $$.label = $1.label;
                    $$.tipo = "Var";
                }
                   ...
                   "\t" + nome_variavel + "->tipo = 2;\n" +
                    ...
                    break;
                        ...
                        if($3.tipo == "Var") {
                            ...
                            $$.traducao += "\t" + nome_variavel + "->i = " + $3.label + "->i;\n";
                        ...
                        case 2 : {
                            ...
                            $$.traducao += "\t" + nome_variavel + "->f = " + $3.label + "->f;\n";
                        ...
                        case 3: {
                           ...
                           if($3.tipo == "Var") {
                            ...
                            $$.traducao += "\t" + nome_variavel + "->b = " + $3.label + "->b;\n";
                        ...
                        case 4: {
                           ...
                           if($3.tipo == "Var") {
                            ...
                            $$.traducao += "\t" + nome_variavel + "->c = " + $3.label + "->c;\n";
            ...
            {   
                ...
                if(esta_no_while || esta_no_for) {
                    ...
                    $$.traducao +=
                        ...
                        $$.traducao += 
                        "\t" + $$.label + "->s = (char *) malloc(" + tamanho_string[$$.label] + ");\n"
                        "\t" + "strcpy(" + $$.label + "->s" + " , " + nome_interno + "->s" + ");\n"
                        "\tgoto fim_tipo_" + to_string(fim_tipo) + ";\n\n"
                    ...
                    if (tipo == "string") {
                        $$.traducao += realizar_contagem(nome_interno, $$.label);
                        $$.traducao += "\t" + $$.label + "->tipo = 5;\n";
                        $$.traducao += "\t" + $$.label + "->s = (char *) malloc(" + tamanho_string[$$.label] + ");\n";
                        $$.traducao += "\tstrcpy(" + $$.label + "->s, " + nome_interno + "->s);\n";

                    } else if (tipo == "char") {
                        $$.traducao += "\t" + $$.label + "->tipo = 4;\n";
                        $$.traducao += "\t" + $$.label + "->c = " + nome_interno + "->c;\n";

                    } else {
                        int tipo_var = tipo_var_dinamica(tipo);
                        $$.traducao += "\t" + $$.label + "->tipo = " + to_string(tipo_var) + ";\n";
                        ...
                        switch(tipo_var) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                $$.traducao += "\t" + $$.label + "->c = " + nome_interno + "->b;\n";
                                break;
                            case 5:
                                $$.traducao += "\t" + $$.label + "->s = " + nome_interno + "->b;\n";
                                break;
                        }
                    }
                }
